<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Error.aspx.cs" Inherits="DataExpressWeb.Error" %>
...
<td >
    ...
    <asp:Panel ID="Panel1" runat="server" Height="115px" Width="469px" 
        ...
        <asp:Panel ID="Panel3" runat="server" BackColor="#CC0000" Font-Bold="True" 
            ...
            ¡ HA SURGIDO UN INCONVENIENTE !</asp:Panel>
<table style="width: 466px; height: 45px">
<tr>
<td>
    <asp:Image ID="Image3" runat="server" Height="42px" 
        ImageUrl="~/Imagenes-dhl/adve.png" Width="45px"/>
    </td>
<td align="center">

<span class="spanMensaje">
    Sentimos mucho las molestias causadas, estamos trabajando para darle un mejor servicio.</span>
    </center>
    </td>
</tr>
</table>
        ...
        <asp:Button CssClass="boton" ID="bSesion" runat="server" BackColor="#CC0000" 
            ...
            Text="Notificar" onclick="bSesion_Click" />
    </asp:Panel>
</td>
</tr>
</table>
