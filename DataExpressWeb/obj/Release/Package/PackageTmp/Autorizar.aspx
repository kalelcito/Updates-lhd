<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Autorizar.aspx.cs" Inherits="DataExpressWeb.Autorizar" %>
...
<td class="style7"><center><H2 style="color: #008000">FACTURAS POR VALIDAR</H2></center></td>
</tr>
<tr><td class="style7"><asp:TextBox ID="tbRFC0" runat="server" ReadOnly="True" Width="535px" 
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" 
    ...
    <asp:Label ID="error" runat="server" BorderStyle="None" ForeColor="Red"></asp:Label>
