<%@ Page Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="notificacionElim.aspx.cs" Inherits="DataExpressWeb.notificacionElim" %>
...
<td class="style8" align="center">
    <asp:Panel ID="P11" runat="server" Height="145px" Width="469px" 
        BackColor="#F2FBEF" BorderColor="#E4B918" BorderStyle="Groove">
        <asp:Panel ID="hd" runat="server" BackColor="#D40511" Font-Bold="True" 
            ForeColor="White" Height="23px" HorizontalAlign="Center">
