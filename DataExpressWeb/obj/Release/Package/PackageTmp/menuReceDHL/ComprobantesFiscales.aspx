<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ComprobantesFiscales.aspx.cs" Inherits="DataExpressWeb.Formulario_web110" Culture="Auto" UICulture="Auto" Async="true" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="HeadContent" runat="server">
    ...
    <script type="text/javascript" language="javascript">
        function HandleEnter(event) {
            ...
            if (keyCode == 13) {
                document.getElementById('<%= Button49.ClientID %>').click();
            }
        }
    </script>
...
<asp:Content ID="MenuIzquierdo" ContentPlaceHolderID="MenuIzquierdo" runat="server">
    <span class="titulo">Comprobantes Fiscales Digitales</span>
    <ul id="navigation">
        ...
        <li>
            <asp:LinkButton ID="LinkButton5" CssClass="sideMenuComprobantesFiscales" runat="server" OnClick="btPagos_Click"> Cargar complemento de Pago</asp:LinkButton></li>
        <li>
            <asp:LinkButton ID="subirSAT" CssClass="sideMenuComprobantesFiscales" runat="server" OnClick="subirSAT_Click"> Subir CFDI del SAT</asp:LinkButton></li>
        <li>
            <asp:LinkButton ID="LbCFDIcancel" CssClass="sideMenuComprobantesFiscales" runat="server" OnClick="btCFDIcancel_Click"> CFDI Cancelación</asp:LinkButton></li>
        <%} %>
        ...
        <%if (!(Session["permisos"].ToString().IndexOf("Proc") < 0))
            { %>
        <li>
            <asp:LinkButton ID="HyperLink8" CssClass="sideMenuComprobantesFiscales"
                runat="server"
                OnClientClick="return confirm('Seguro que desea mandar el CFDI a Proceso de Pago');"
                OnClick="HyperLink8_Click"> A Proceso de Pago</asp:LinkButton></li>
        <%} %>
        ...
        <%} %>
        <li>
            <asp:LinkButton ID="LinkB" CssClass="sideMenuComprobantesFiscales"
                runat="server" OnClick="LinkB_Click"> Habilitar para interfaz</asp:LinkButton></li>
        <li>
...
<asp:Content ID="Content3" ContentPlaceHolderID="MainContent" runat="server">
    <h1 style="width: 320px">Comprobantes Fiscales Digitales</h1>
    ...
    <center>
       ...
       <asp:Label ID="LabelMENSAJE" runat="server" Text="Está seguro de querer considerar el registro seleccionado para incluirse en la siguiente interface?" Font-Names="Arial" Font-Size="12px"></asp:Label>
                                   <br />
<asp:Button CssClass="botonForm"  ID="But2" runat="server"  Text="Actualizar"                        
                                      onclick="But2_Click" />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<asp:Button CssClass="botonForm" ID="But" runat="server"  Text="Cancelar" onclick="But_Click" /> 
...
<span ID="bus4">
                ...
                <asp:Panel ID="PanelBusca" CssClass="panelWrapper" runat="server"
                        ...
                        Filtro</asp:Panel>
                                            <asp:Panel ID="Panel46" runat="server" BorderColor="#666666" BorderStyle="Solid" 
                                                Height="340px" Width="384px" BorderWidth="1px">
                                                <table style="width: 383px; height: 290px;">
                                                    <tr>
                                                        <td>
                                                            Proveedor:</td>
                                                        <td colspan="2">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td colspan="2">
                                                            <asp:TextBox ID="Tfol" runat="server" Width="244px" Font-Size="Smaller"
                                                                onkeyup="HandleEnter(event)"
                                                                TextMode="SingleLine" Height="26px" OnTextChanged="Tfol_TextChanged"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td >
                                         ...
                                         <tr>
                                                    ...
                                                    <tr>
                                                        <td>
                                                           Correo Analista:</td>
                                                        <td colspan="2">
                                                            <asp:TextBox ID="TcorAna" runat="server" Width="244px" Font-Size="Smaller"
                                                                onkeyup="HandleEnter(event)"
                                                                TextMode="SingleLine" Height="20px"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td valign="baseline" align="left">
                                                                <asp:TextBox ID="tbFechaIni" runat="server" Width="110px" Height="20px" Font-Size="Small" Visible="True" onkeyup="HandleEnter(event)"></asp:TextBox>
                                                        ...
                                                        <td valign="baseline"  align="right">
                                                            -
                                                                <asp:TextBox ID="tbFechaFin" runat="server" Width="110px" Height="20px" Font-Size="Small" Visible="True" onkeyup="HandleEnter(event)"></asp:TextBox>
                                            ...
                                            <br />
                                            <asp:Button ID="Button49" runat="server" BackColor="#d40511" BorderColor="#E4B918" 
                                                BorderStyle="Ridge" Font-Bold="True" Height="23px" 
                                                ...
                                                <table style="width: 383px; height: 86px;">
                                                  ...
                                                  <%--  <tr>
                                                        <td>
                                                            Tipo CFDI:</td>
                                                        <td>
                                                            <asp:DropDownList ID="DropDownListCFDI" runat="server" DataValueField="codigoISO" Height="17px" Width="145px">
                                                                <asp:ListItem>Bienes y Servicios</asp:ListItem>
                                                                <asp:ListItem>Rentas con Retencion</asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>--%>
        ...
        <asp:TemplateField HeaderText="Archivo">
            <ItemTemplate>
            <center>
            <a href= '../download.aspx?file=<%# Eval("ADIARC").ToString().Replace("&","_") %>'>
             ...
             <center style="height: 86px">
              ...
              <br />
                                ...
                                <asp:GridView ID="gvFacturas" class="tablaFac" runat="server" DataSourceID="SqlDataSource1" AutoGenerateColumns="False" 
                                    CellPadding="1" DataKeyNames="idFactura" ShowHeader = "true" ForeColor="#333333" GridLines="None"  style="margin-top: 0px; Width:800px" BorderColor="#CC0000" 
        BorderStyle="solid" BorderWidth="1px" Font-Size="10px" Font-Bold="True" CellSpacing="1" AllowPaging="True" onselectedindexchanged="gvFacturas_SelectedIndexChanged" OnRowDataBound="gvFacturas_RowDataBound" >
      <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
    <Columns >
     <asp:ImageField DataImageUrlField="EDOFAC" DataImageUrlFormatString="~/Imagenes/{0}.png" HeaderText="Estatus" Visible="false" >
        ...
        <asp:TemplateField HeaderText="O/C" HeaderStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink2" height="15" width="15" runat="server" BorderWidth="0px" BorderStyle="None" 
                             Visible='<%# Eval("facSAT").ToString() == ("0") %>' NavigateUrl='<%#  Eval("ORDENARC","~/download.aspx?file={0}").ToString().Replace("&","_") %>' >       
        ...
        <asp:TemplateField HeaderText="PDF" HeaderStyle-HorizontalAlign="Center">
                        <ItemTemplate>
                            <asp:HyperLink ID="HyperLink1" height="15" width="15" runat="server" BorderWidth="0px" BorderStyle="None" 
                             Visible='<%# Eval("facSAT").ToString() == ("0") %>' NavigateUrl='<%# Eval("PDFARC","~/download.aspx?file={0}").ToString().Replace("&","_") %>' >       
        ...
        <asp:TemplateField HeaderText="Tipo de Proveedor" SortExpression="tipProv" ControlStyle-Width="110px" ItemStyle-HorizontalAlign="Center">
            <EditItemTemplate>
        ...
        <asp:TemplateField HeaderText="Fecha de Emisión" SortExpression="FECHA" ControlStyle-Width="100px">
            <EditItemTemplate>
        ...
        <asp:TemplateField HeaderText="Fecha de Ultimo Cambio" SortExpression="fechUlt" ControlStyle-Width="100px">
            <EditItemTemplate>
        ...
        <asp:TemplateField HeaderText="Código Contable" SortExpression="Código Contable" ItemStyle-HorizontalAlign="Center">
            <EditItemTemplate>
                <asp:TextBox ID="tbCodCont" runat="server" Text='<%# Bind("CodCont") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:Label ID="lCodCont" runat="server" Width="140px" Text='<%# Bind("CodCont") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
         <asp:TemplateField HeaderText="Correo de Contacto DHL" SortExpression="correCont">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox14" runat="server" Text='<%# Bind("correoAnalista") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:Label ID="Label14" runat="server" Width="180px" Text='<%# Bind("correoAnalista") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Fecha de Rechazo" SortExpression="fechRecha" ItemStyle-Width="134px">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox15" runat="server" Text='<%# Bind("fechaRechazo") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:Label ID="Label152" runat="server" Width="134px" Text='<%# Bind("fechaRechazo") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        <asp:TemplateField HeaderText="Causa de Rechazo" SortExpression="cauRecha" ItemStyle-Width="50px">
            <EditItemTemplate>
                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("causaRechazo") %>'></asp:TextBox>
            </EditItemTemplate>
            <ItemTemplate>
                <asp:Label ID="Label78" runat="server" Width="250px" Text='<%# Bind("causaRechazo") %>'></asp:Label>
            </ItemTemplate>
        </asp:TemplateField>
        ...
        <asp:TemplateField HeaderText="UUID Complemento de pago" SortExpression="UUIDP" ItemStyle-HorizontalAlign="Center">
                                <EditItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Fecha de Recepcion de Complemento de pago" SortExpression="fechaP" ItemStyle-HorizontalAlign="Center">
                                <EditItemTemplate>
    ...
    <asp:TemplateField HeaderText="Resultado Validación" Visible="False">
            <ItemTemplate>
             <a href="javascript:openPopup('ResultadoVal.aspx?idfa=<%# Eval("idFactura") %>')">
                <img  src="../../imagenes/info.ico" alt="pdf" border="0" align="middle" height="22" width="22"></a>
            </ItemTemplate>  
    </asp:TemplateField>
         <asp:TemplateField HeaderText="ENVIAR" Visible="False">
            <ItemTemplate>
             <a href="javascript:openPopup('enviar.aspx?idfa=<%# Eval("idFactura") %>')">
                <center>
                <img  src="imagenes/mail.png" alt="pdf" border="0" align="middle" height="22" width="22"></a></center>
            </ItemTemplate>         
        </asp:TemplateField>
    </Columns>
    ...
    <HeaderStyle BackColor="#C31A1A" Font-Bold="True" ForeColor="White" Font-Size="10px" Wrap="False" BorderColor="White" />
    <PagerStyle BackColor="#d40511" ForeColor="White" HorizontalAlign="Left" Wrap="False" />
    <RowStyle BackColor="#f2f2ed" ForeColor="#333333" />
    <SelectedRowStyle BackColor="White" ForeColor="#333333" Font-Bold="True" />
    <SortedAscendingCellStyle BackColor="#E9E7E2"/>
    <SortedAscendingHeaderStyle BackColor="#506C8C" />
    <SortedDescendingCellStyle BackColor="#FFFDF8" />
    <SortedDescendingHeaderStyle BackColor="#6F8DAE" />
...
<asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:receHiltonSFConnectionString %>" SelectCommand="PA_facturas_basico_rec_2" SelectCommandType="StoredProcedure" >
    <SelectParameters>
    ...
    <asp:Panel ID="pnlPaymen" CssClass="modalPopupMP" runat="server" align="center" Style="display: none">
    ...
    <ajaxToolkit:ModalPopupExtender ID="vAddPagos" PopupControlID="pnlEditar" runat="server" BackgroundCssClass="modalBackground" TargetControlID="alone1"></ajaxToolkit:ModalPopupExtender>
    <asp:Panel ID="pnlEditar" runat="server" align="center" Style="display: none" CssClass="modalPopupMP" Width="500px" Height="200px">
        ...
        <asp:UpdatePanel ID="upAddPayment" runat="server" align="center" ChildrenAsTriggers="true">
            <ContentTemplate>
                <div>
                    <table>
                        <tr>
    ...
    <ajaxToolkit:ModalPopupExtender ID="modalCFDIcancel" PopupControlID="pnlCFDIcancel" runat="server" BackgroundCssClass="modalBackground" TargetControlID="alone2"></ajaxToolkit:ModalPopupExtender>
    <asp:Panel ID="pnlCFDIcancel" CssClass="modalPopupMP" runat="server" align="center" Style="display: none">
        <table>
            <tr>
                <td colspan="2" align="center">
                    <asp:Label ID="Label15" runat="server" Text="AGREGAR CFDI CANCELADO" Font-Bold="true"></asp:Label>
                    <br />
                    <br />
                </td>
            </tr>
            <tr>
                <td colspan="2" align="center">
                    <asp:Label ID="Label17" runat="server" Text="UUID:" Font-Bold="true"></asp:Label>

                    <asp:TextBox ID="tbUUID" runat="server" Width="377px"></asp:TextBox>
                    <br />
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="Label18" runat="server" Text="RFC Emisor:" Font-Bold="true"></asp:Label>
                    <asp:TextBox ID="tbRFCe" runat="server" Width="100px"></asp:TextBox>
                </td>
                <td>
                    <asp:Label ID="Label4" runat="server" Text="RFC Receptor:" Font-Bold="true"></asp:Label>
                    <asp:DropDownList ID="ddRFCr" runat="server" DataSourceID="SqlDataSourceRecepCFDI" DataTextField="rfc" DataValueField="rfc">
                    </asp:DropDownList>
                    <br />
                </td>
            </tr>
            <tr>
                <td align="center" colspan="2">
                    <asp:Label ID="Label19" runat="server" Text="" Font-Bold="true" ForeColor="#d40511" Visible="false"></asp:Label>
                </td>
            </tr>
            <tr>
                <td align="center" colspan="2">
                    <asp:Button ID="btAdd" runat="server" Text="Agregar" Width="100px" ForeColor="Black" CssClass="btGrisNegrita" OnClick="btnCFDIAdd_Click" />
                    <asp:Button ID="btCancel" runat="server" Text="Cancelar" Width="100px" ForeColor="Black" CssClass="btGrisNegrita" OnClick="btnCFDICancel_Click" />
                    <br />
                    <br />
                </td>
            </tr>
        </table>
        <asp:SqlDataSource ID="SqlDataSourceRecepCFDI" runat="server" ConnectionString="<%$ ConnectionStrings:recepcionConnectionString %>"
            SelectCommand="SELECT idreceptorCFDI, rfc FROM receptorCFDI ORDER BY RFC ASC"></asp:SqlDataSource>
        <div>
            <asp:GridView ID="gvUUIDcancel" runat="server" AutoGenerateColumns="False" CssClass=" table table-condensed table-responsive table-hover"
                PageSize="10" BackColor="White" AllowPaging="True" AllowSorting="True" Font-Size="Small" GridLines="None" DataSourceID="SqlDataSourceUUIDcancel"
                DataKeyNames="idCFDIcancel" EnableModelValidation="False" BorderColor="#CC0000" BorderStyle="Solid" BorderWidth="1px" CellSpacing="1" CellPadding="1">
                <AlternatingRowStyle BackColor="White" ForeColor="#284775" />
                <Columns>
                    <asp:BoundField DataField="UUID" HeaderText="UUID" ItemStyle-Font-Size="10px" />
                    <asp:BoundField DataField="rfcEMI" HeaderText="RFC Emisor" ItemStyle-Font-Size="10px" ControlStyle-Width="80px" />
                    <asp:BoundField DataField="rfcREC" HeaderText="RFC Receptor" ItemStyle-Font-Size="10px" ControlStyle-Width="80px" />
                    <asp:TemplateField ShowHeader="False" HeaderText="Acciones" ItemStyle-Font-Size="10px">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtDelete" runat="server" OnClientClick="return confirm('¿Deseas eliminar este grupo validador?');"
                                CommandArgument='<%#Bind("idCFDIcancel") %>' OnClick="lbtDelete_Click" Text="Eliminar" CssClass="btGrisNegrita">
                            </asp:LinkButton>
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
                <FooterStyle />
                <HeaderStyle BackColor="#d40511" Font-Bold="True" ForeColor="White" Font-Names="Arial" Font-Size="11px" />
                <PagerStyle CssClass="bs-pagination" HorizontalAlign="Center" />
                <PagerSettings />
                <RowStyle />
                <SelectedRowStyle />
            ...
            <asp:SqlDataSource ID="SqlDataSourceUUIDcancel" ConnectionString="<%$ ConnectionStrings:receHiltonSFConnectionString %>" runat="server" SelectCommand="SELECT * FROM CFDIcancelacion ORDER BY 1 DESC"></asp:SqlDataSource>
        </div>
